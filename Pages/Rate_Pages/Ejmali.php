...
?>
<!-- Main content -->
<form method="post" action="build/php/inc/Ejmali_Rate_Inc.php">
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped" id="myTable">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        if ($item['ejmali1_ratercode_g1'] == $Me or $item['ejmali2_ratercode_g1'] == $Me or $item['ejmali3_ratercode_g1'] == $Me) {
                            ...
                            echo $groupInfo['name'];
                        } elseif ($item['ejmali1_ratercode_g2'] == $Me or $item['ejmali2_ratercode_g2'] == $Me or $item['ejmali3_ratercode_g2'] == $Me) {
