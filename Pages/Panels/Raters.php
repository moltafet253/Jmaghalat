    ...
    <div class="card card-success">
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped" id="myTable">
                ...
                $Me = $_SESSION['id'];
                $query = mysqli_query($connection_maghalat, "select * from article where rate_status like '%اجمالی%' and (ejmali1_ratercode_g1='$Me' or ejmali2_ratercode_g1='$Me' or ejmali3_ratercode_g1='$Me' or ejmali1_ratercode_g2='$Me' or ejmali2_ratercode_g2='$Me' or ejmali3_ratercode_g2='$Me') order by festival_id asc ");
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        if ($Ejmali_list['ejmali1_ratercode_g1'] == $Me or $Ejmali_list['ejmali2_ratercode_g1'] == $Me or $Ejmali_list['ejmali3_ratercode_g1'] == $Me) {
                            ...
                            echo $groupInfo['name'];
                        } elseif ($Ejmali_list['ejmali1_ratercode_g2'] == $Me or $Ejmali_list['ejmali2_ratercode_g2'] == $Me or $Ejmali_list['ejmali3_ratercode_g2'] == $Me) {
                    ...
                    <td>
                        <form action="Rate.php" method="post">
                            ...
                            <input type="hidden" name="rate_status"
                                   value="<?php
                                   if ($Ejmali_list['ejmali1_ratercode_g1'] == $Me) {
                                       echo 'ej1g1';
                                   } elseif ($Ejmali_list['ejmali2_ratercode_g1'] == $Me) {
                                       echo 'ej2g1';
                                   } elseif ($Ejmali_list['ejmali3_ratercode_g1'] == $Me) {
                                       echo 'ej3g1';
                                   } elseif ($Ejmali_list['ejmali1_ratercode_g2'] == $Me) {
                                       echo 'ej1g2';
                                   } elseif ($Ejmali_list['ejmali2_ratercode_g2'] == $Me) {
                                       echo 'ej2g2';
                                   } elseif ($Ejmali_list['ejmali3_ratercode_g2'] == $Me) {
                                       echo 'ej3g2';
                                   }
                                   ?>"
                            >
