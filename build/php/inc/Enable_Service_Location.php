...
if (isset($_POST['Service_Location']) and !empty($_SESSION['id'])) {
    ...
    if (!empty($check)){
        mysqli_query($connection_variables,"update service_location set active=1 where subject='$Service_Location'");
        header("Location: ../../../catalogs.php?Service_Location_Enabled");
    }else{
