        ...
        $ext_pdf = pathinfo($file_url_name, PATHINFO_EXTENSION);
                ...
                if (@$_POST['select_for_jm_' . $i] != 'on') {
                    mysqli_query($connection_mag, "insert into mag_articles (mag_version_id,subject,body,type,scientific_group_1,scientific_group_2,
                                            number_of_page_in_mag_from,number_of_page_in_mag_to,language,author,cooperation_type,file_url,adder,added_date)
                                            values ('$mag_version_id','$subject','$body','$type','$scientific_group1','$scientific_group2','$number_of_page_in_mag_from',
                                            '$number_of_page_in_mag_to','$language','$author','$cooperation_type','$file_url_table','$adder','$datewithtime')");
                } else {
                    mysqli_query($connection_mag, "insert into mag_articles (mag_version_id,subject,body,type,scientific_group_1,scientific_group_2,
                                            number_of_page_in_mag_from,number_of_page_in_mag_to,language,author,cooperation_type,selected_for_jm,file_url,adder,added_date)
                                            values ('$mag_version_id','$subject','$body','$type','$scientific_group1','$scientific_group2','$number_of_page_in_mag_from',
                                            '$number_of_page_in_mag_to','$language','$author','$cooperation_type',1,'$file_url_table','$adder','$datewithtime')");
                }
