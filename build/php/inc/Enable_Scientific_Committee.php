...
if (isset($_POST['Scientific_Committee']) and !empty($_SESSION['id'])) {
    $user=$_SESSION['id'];
    $Scientific_Committee=$_POST['Scientific_Committee'];
    ...
    if (!empty($check)){
        mysqli_query($connection_variables,"update mag_festival_scientific_committee set active=1 where id='$Scientific_Committee'");
